...
const greeting = {
  ...
  subTitle: emoji(
    "A passionate Full Stack Software Developer 🚀 having an experience of building Web and Mobile applications with JavaScript / Reactjs / Nodejs / Databases and some other cool libraries and frameworks."
  ),
  resumeLink:
    "https://www.keepandshare.com/doc28/110165/tarun-s-resume-pdf-402k?da=y",
};
...
const skillsSection = {
  title: emoji("What I Love❤️ to do"),
  subTitle: "FULL STACK DEVELOPER WHO WANTS TO EXPLORE TREANDING TECH STACK",
  skills: [
    emoji(
...
const openSource = {
  githubConvertedToken:
    "YjZmMzhhZGFiMmIxMzg5YjU5MmY0MDg2YmVlNDJiMWQ0OGE3ODY3YQ==",
  githubUserName: "Taruntyagi93",
...
const bigProjects = {
  ...
  projects: [
    {
      image:
        "http://drive.google.com/uc?export=view&id=1GhyXwQEZwJz9n9BIO8yZBOlM7K2hgW4a",
      link: "https://www.cray.com/",
    },
    {
      image:
        "http://drive.google.com/uc?export=view&id=1LPatDN5ETV0_EWlwj4mSO8J-FmyBfUwi",
      link: "https://www.aon.com/home/index.html",
    },
    {
      image:
        "http://drive.google.com/uc?export=view&id=10hQmyAhlTwmk7pZxmkWzdzskeGgU-IME",
...
const twitterDetails = {
  userName: "taruntyagi93", //Replace "twitter" with your twitter username without @
};
export {
  greeting,
  socialMediaLinks,
